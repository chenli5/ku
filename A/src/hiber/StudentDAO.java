...
public class StudentDAO extends BaseHibernateDAO {
	...
	public Student findById(java.lang.String id) {
		...
		try {
			Student instance = (Student) getSession().get("hiber.Student", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Student instance) {
		...
		try {
			List results = getSession().createCriteria("hiber.Student")
	...
	public List findBySscore(Object sscore) {
		return findByProperty(SSCORE, sscore);
	}
