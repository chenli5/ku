...
public class AdminDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String APASS = "apass";
	...
	public Admin findById(java.lang.String id) {
		...
		try {
			Admin instance = (Admin) getSession().get("hiber.Admin", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Admin instance) {
		...
		try {
			List results = getSession().createCriteria("hiber.Admin")
	...
	public List findByApass(Object apass) {
		return findByProperty(APASS, apass);
	}
