...
public class TeacherDAO extends BaseHibernateDAO {
	...
	public Teacher findById(java.lang.String id) {
		...
		try {
			Teacher instance = (Teacher) getSession().get("hiber.Teacher", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = getSession().createCriteria("hiber.Teacher")
	...
	public List findByTpw(Object tpw) {
		return findByProperty(TPW, tpw);
	}
